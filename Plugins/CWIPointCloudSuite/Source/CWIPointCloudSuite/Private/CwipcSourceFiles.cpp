...
UCwipcSourceFiles::UCwipcSourceFiles(const FObjectInitializer& ObjectInitializer)
    : UCwipcSource(ObjectInitializer)
{
	DBG UE_LOG(LogTemp, Display, TEXT("UCwipcSourceFiles::UCwipcSourceFiles() on 0x%p called"), (void*)this);
}
